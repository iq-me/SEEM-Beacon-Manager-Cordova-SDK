...
/**
 Send after a beacon proximity get a new value.
 @param beaconListener The beacon controller which has called the method.
 @param beacon The beacon that was exit.
 @param event The information about the changed beacon proximity.
 @since 1.0.4
 */
- (void)beaconListener:(SEEMBeaconListener *)beaconListener onChangeBeaconProximity:(SEEMBeacon *)beacon withEvent:(SEEMBeaconEvent *)event;
...
/**
 Executes a handler block on beacon proximity changed.
 @param onChange The handler block to execute.
 @since 1.0.4
 */
- (void)onChangeBeaconProximity:(BeaconAction)onChange;
